...
static int merge_count_inversions(Iterator first, Iterator mid, Iterator last, Iterator buffer_start, Comparator C) noexcept;

template<typename Iterator, typename Comparator>
static int merge_sort_count_inversions(Iterator first, Iterator last, Iterator work_buffer, Comparator c) noexcept;
...
template<typename T, typename Iterator, typename Comparator> int count_inversions(Iterator first, Iterator last, Comparator C) noexcept
{
   ...
   int inversions = merge_sort_count_inversions(first, last, work_buffer.get(), C);
